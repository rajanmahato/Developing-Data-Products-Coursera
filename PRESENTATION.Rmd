...
3. The GitHub repository containing the R codes required to build the Shiny App (**server.R** and **ui.R**)can be accessed [here](https://github.com/rajanmahato/Developing-Data-Products)
2. The Shiny app can be accessed [here](https://urlzs.com/vBQ2U), which contains
